...
// It is expected that the provided path root prefix will serve all operations.
// Root MUST NOT end in a slash.
// caller: staging/src/k8s.io/apiserver/pkg/server/genericapiserver.go -> installAPIResources()
func (g *APIGroupVersion) InstallREST(container *restful.Container) error {
	...
	versionDiscoveryHandler := discovery.NewAPIVersionHandler(
		g.Serializer, g.GroupVersion, staticLister{apiResources},
	)
